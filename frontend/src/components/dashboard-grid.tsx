...
import { HealthScoreCard } from "@/plugins/repo-health/widgets/health-score-card";
import { HealthTable } from "@/plugins/repo-health/widgets/health-table";
import { PrsOverviewCard } from "@/plugins/pull-requests/widgets/prs-overview-card";
import { IssuesOverviewCard } from "@/plugins/pull-requests/widgets/issues-overview-card";
import { PrsDraftRatio } from "@/plugins/pull-requests/widgets/prs-draft-ratio";
import { PrsAgeDistribution } from "@/plugins/pull-requests/widgets/prs-age-distribution";
import { IssuesByLabel } from "@/plugins/pull-requests/widgets/issues-by-label";
import { PrsStaleTable } from "@/plugins/pull-requests/widgets/prs-stale-table";
...
import { DevPrCycleTime } from "@/plugins/developer-metrics/widgets/dev-pr-cycle-time";
import { DevPrMergeRate } from "@/plugins/developer-metrics/widgets/dev-pr-merge-rate";
import { DevTopCommitters } from "@/plugins/developer-metrics/widgets/dev-top-committers";
import { DevCycleTimeTrend } from "@/plugins/developer-metrics/widgets/dev-cycle-time-trend";
import { DevLeaderboard } from "@/plugins/developer-metrics/widgets/dev-leaderboard";
import { CiStatusSummary } from "@/plugins/ci-cd/widgets/ci-status-summary";
import { CiFailingWorkflows } from "@/plugins/ci-cd/widgets/ci-failing-workflows";
import { CiDurationTrend } from "@/plugins/ci-cd/widgets/ci-duration-trend";
import { CiRunHistory } from "@/plugins/ci-cd/widgets/ci-run-history";
